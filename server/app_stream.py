#!/usr/bin/env python3
"""
Listenr Web Server - Live Streaming Edition
...
Features:
- Continuous microphone streaming (no start/stop button!)
- Real-time transcription via WebSockets
- Live VAD feedback (see when speech is detected)
...
def index():
    ...
    with open(Path(__file__).parent / 'templates' / 'index_stream.html', 'r') as f:
